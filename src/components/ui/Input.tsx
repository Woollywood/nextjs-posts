...
export const Input = ({ className, label, ...props }: Props, ref?: React.Ref<HTMLInputElement> | undefined) => {
	...
	const id = useId();
	const _className = cn(
		'px-3 py-2 ring-1 ring-white bg-transparent rounded-md placeholder:text-gray-600 hover:ring-gray-400 transition-shadow focus:ring-gray-400 outline-none text-sm w-full',
		className,
	);
